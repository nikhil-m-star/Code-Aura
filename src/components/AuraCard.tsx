    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
        <div className="flex items-center gap-4">
          <img
            ...
            alt={github.username}
            className="w-16 h-16 sm:w-18 sm:h-18 rounded-2xl object-cover bg-[#111]"
          />
          <div>
            ...
            <div className="flex items-center gap-2 mt-2 flex-wrap">
              ...
              <span className="text-[10px] px-2.5 py-1 rounded-lg bg-[#222] text-gray-200 font-extrabold">
                {github.timeSlot}
              </span>
            </div>
          </div>
      ...
      <div className="p-6 rounded-2xl bg-[#111] space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] px-2.5 py-1 rounded-lg bg-[#222] text-gray-200 font-black">
        ...
        <div className="space-y-3.5">
          {ratingBars.map((bar) => (
            <div key={bar.label} className="flex items-center gap-4">
              ...
              <span className="text-xs text-white font-black w-10 text-right">{bar.value}%</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
        {[
          ...
          <div key={stat.label} className={`p-3.5 rounded-2xl ${stat.bg} text-center`}>
            ...
            <div className={`text-[10px] uppercase font-black tracking-wider mt-0.5 ${stat.text} opacity-80`}>{stat.label}</div>
          </div>
        ))}
      </div>
